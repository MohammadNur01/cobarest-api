...
$data = file_get_contents('data/menu-resto.json');
$menu = json_decode($data, true);
if ($menu["kategori" == "camilan"]) {
  $camilan = $menu["menu"];
} else {
  echo "camilan tidak ditemukan";
}
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          <a class="nav-link active" aria-current="page" href="camilan.php">Camilan</a>
        </div>
      </div>
    </div>
